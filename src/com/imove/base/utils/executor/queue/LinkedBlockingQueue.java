...
public class LinkedBlockingQueue<E> extends AbstractQueue<E>
        implements LockBlockingQueue<E>, java.io.Serializable {
    ...
    private final ReentrantLock operateLock = new ReentrantLock();
...
//     }
    ...
    private void writeObject(java.io.ObjectOutputStream s)
        ...
        try {
            ...
            Iterator<E> iterator= linkList.iterator();
