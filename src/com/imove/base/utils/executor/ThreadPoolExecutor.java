...
import com.imove.base.utils.executor.queue.LockBlockingQueue;
...
public class ThreadPoolExecutor extends AbstractExecutorService {
    ...
    private List<Runnable> drainQueue() {
    	LockBlockingQueue<Runnable> q = workQueue;
        List<Runnable> taskList = new ArrayList<Runnable>();
        q.drainTo(taskList);
        if (!q.isEmpty()) {
        	Runnable[] runnables = q.toArray(new Runnable[0]);
    ...
    public ThreadPoolExecutor(int corePoolSize,
                              ...
                              long keepAliveTime,
                              TimeUnit unit,
                              LockBlockingQueue<Runnable> workQueue) {
