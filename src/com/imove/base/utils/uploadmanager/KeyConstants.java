...
public class KeyConstants {
	 ...
	 * 未知状态
	 */
	public final static int UPLOAD_STATE_UNKOWN = UNKOWN_KEY;
	/**
	 * 无状态
	 */
	public final static int UPLOAD_STATE_NONE = -2;
	/**
	 * 下载失败
	 */
	public final static int UPLOAD_STATE_FAIL = -1;
	/**
	 * 下载成功
	 */
	public final static int UPLOAD_STATE_SUC = 0;
	/**
	 * 下载排队中
	 */
	public final static int UPLOAD_STATE_PENDING = 1;
	/**
	 * 下载准备中
	 * 进入下载中的队列
	 */
	public final static int UPLOAD_STATE_INTO_UPLOADING_QUEUE = 2;
	/**
	 * 下载准备中
	 * 连接服务器等操作
	 */
	public final static int UPLOAD_STATE_PREPARE = 3;
	/**
	 * 开始下载
	 * 连接上服务器，开始接受文件流
	 */
	public final static int UPLOAD_STATE_START = 4;
	/**
	 * 下载中
	 */
	public final static int UPLOAD_STATE_UPLOADING = 5;
	/**
	 * 下载停止
	 */
	public final static int UPLOAD_STATE_PAUSE = 6;
	
	public final static String UPLOADER_INSTANCE_ID = "UPLOAD_service";
	
	public final static String GAME_UPLOADER_INSTANCE_ID = "game_UPLOAD_service";
	
	public final static String SCAN_UPLOADER_INSTANCE_ID = "scan_UPLOAD_service";
	 ...
	 * 目标文件的下载长度为0
	 */
	public final static int ERROR_REASON_HTTP_UPLOAD_LENGTH_ERROR = -6;
	/**
	 * 其他错误
	 ...
	 * 正在下载中，又被调用下载则会返回下载中
	 */
	public final static int ERROR_REASON_UPLOADING = -9;
