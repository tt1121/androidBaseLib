...
import com.imove.base.utils.executor.Callable;
import com.imove.base.utils.executor.Executor;
import com.imove.base.utils.executor.FutureTask;
...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    public Executor THREAD_POOL_EXECUTOR
            = ThreadPoolManager.getInstance(TYPE_NORMAL).getExecutor();
    ...
    public void setThreadType(int type) {
    	THREAD_POOL_EXECUTOR = ThreadPoolManager.getInstance(type).getExecutor();
    }
