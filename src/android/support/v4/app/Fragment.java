...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public void onHiddenChanged(boolean hidden) {
    	if (mHiddenChangeListener != null) {
    		mHiddenChangeListener.onHiddenChanged(this, hidden);
    	}
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    	if (mLifeCycleListener != null) {
    		mLifeCycleListener.onViewCreated(this);
    	}
    }
    ...
    */
    ...
    public void setOnFragmentLifeCycleListener(OnFragmentLifeCycleListener l) {
    	this.mLifeCycleListener = l;
    }
    ...
    private OnFragmentHiddenChangeListener mHiddenChangeListener;
    
    public void setOnFragmentHiddenChangeListener(OnFragmentHiddenChangeListener l) {
    	this.mHiddenChangeListener = l;
    }
